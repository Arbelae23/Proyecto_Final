...
int main(int argc, char *argv[])
{
    ...
    QPixmap backgroundPixmap("C:/Users/Maria.Lucia/Pictures/Sprites/Sprites/013.jpg");
    QGraphicsPixmapItem* backgroundItem = new QGraphicsPixmapItem(backgroundPixmap);
    backgroundItem->setPos(0, 0);
    scene.addItem(backgroundItem);

    // Cargar la imagen del cronómetro
    QPixmap cronometroPixmap("C:/Users/Maria.Lucia/Pictures/Sprites/Sprites/cronometro.png");
    ...
    QPixmap fondoPixmap("C:/Users/Maria.Lucia/Pictures/Sprites/Sprites/fondo_aciertos.png");
    ...
    QPixmap aveMuertaPixmap("C:/Users/Maria.Lucia/Pictures/Sprites/Sprites/ave_muerta.png");
    ...
    Aves* ave = new Aves(200, 200, "C:/Users/Maria.Lucia/Pictures/Sprites/Sprites/Ave.png", 1);
    scene.addItem(ave);

    // Crear la segunda ave y agregarla a la escena
    Aves* ave2 = new Aves(200, 200, "C:/Users/Maria.Lucia/Pictures/Sprites/Sprites/Ave.png", 2);
    scene.addItem(ave2);
    ...
    QPixmap gameOverPixmap("C:/Users/Maria.Lucia/Pictures/Sprites/Sprites/game_over.png");
    ...
    QPixmap youWinPixmap("C:/Users/Maria.Lucia/Pictures/Sprites/Sprites/you_win.png");
