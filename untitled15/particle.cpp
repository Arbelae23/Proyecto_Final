    ...
    m_showExplosion(false) // Inicializar la bandera de explosión
{
    ...
    m_pixmap.load("C:/Users/Maria.Lucia/Pictures/Sprites/Sprites/Mira.png"); // ruta de la imagen de la partícula
...
void Particle::keyPressEvent(QKeyEvent* event)
{
    ...
    case Qt::Key_Space: // Tecla espacio presionada
        m_explosionPixmap.load("C:/Users/Maria.Lucia/Pictures/Sprites/Sprites/Explosion.png"); // Cargar imagen de explosión
